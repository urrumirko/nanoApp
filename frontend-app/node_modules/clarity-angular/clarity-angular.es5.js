...
var DatagridCell = (function () {
     ...
     * @param {?} _renderer
     */
    function DatagridCell(hideableColumnService, _el, _renderer) {
        this.hideableColumnService = hideableColumnService;
        this._el = _el;
        this._renderer = _renderer;
    }
    Object.defineProperty(DatagridCell.prototype, "id", {
        /**
         * @param {?} value
         * @return {?}
         */
     ...
     * @return {?}
     */
    DatagridCell.prototype.mapHideableColumn = function (columnId) {
        var _this = this;
        if (!columnId) {
            return;
        }
        var /** @type {?} */ hideableColumn = this.hideableColumnService.getColumnById(this._id);
     ...
     * @return {?}
     */
    DatagridCell.prototype.setHiddenClass = function (hideableColumnValue) {
     ...
     * @return {?}
     */
    DatagridCell.prototype.ngOnDestroy = function () {
    ...
    Object.defineProperty(Selection.prototype, "currentSingle", {
        ...
        set: function (value) {
            ...
            if (this._items.all && this._items.trackBy && value) {
                var /** @type {?} */ lookup = this._items.all.findIndex(function (maybe) { return maybe === value; });
    ...
    Selection.prototype.setSelected = function (item, selected) {
        switch (this._selectionType) {
            ...
            case SelectionType.Multi:
                ...
                var /** @type {?} */ trackBy = this._items.trackBy;
                if (index >= 0 && !selected) {
                    ...
                    if (trackBy) {
                        ...
                        var /** @type {?} */ lookup = this._items.all.findIndex(function (maybe) { return maybe === item; });
...
var ColumnToggleButtonsService = (function () {
    function ColumnToggleButtonsService() {
        ...
        this._okButtonClicked = new Subject$1();
        this._selectAllButtonClicked = new Subject$1();
    }
 ...
 * The full license information can be found in LICENSE in the root directory of this project.
 */
var DatagridColumnToggleButton = (function () {
    /**
     * @param {?} toggleButtons
     */
    function DatagridColumnToggleButton(toggleButtons) {
        this.toggleButtons = toggleButtons;
    }
    /**
     * @return {?}
     */
    DatagridColumnToggleButton.prototype.getClasses = function () {
        var /** @type {?} */ classes = "btn ";
        if (this.isOk()) {
            classes += "btn-primary";
        }
        else {
     ...
     * @return {?}
     */
    DatagridColumnToggleButton.prototype.isOk = function () {
        return this.clrType === "ok";
    };
    /**
     * @return {?}
     */
    DatagridColumnToggleButton.prototype.click = function () {
        this.toggleButtons.buttonClicked(this.clrType);
    };
    return DatagridColumnToggleButton;
}());
DatagridColumnToggleButton.decorators = [
    { type: Component, args: [{
 ...
 * @nocollapse
 */
DatagridColumnToggleButton.ctorParameters = function () { return [
    { type: ColumnToggleButtonsService, },
]; };
DatagridColumnToggleButton.propDecorators = {
    'clrType': [{ type: Input },],
};
/*
 * Copyright (c) 2016-2018 VMware, Inc. All Rights Reserved.
 ...
 * The full license information can be found in LICENSE in the root directory of this project.
 */
var DatagridColumnToggleTitle = (function () {
    function DatagridColumnToggleTitle() {
    }
    return DatagridColumnToggleTitle;
}());
DatagridColumnToggleTitle.decorators = [
    { type: Component, args: [{
 ...
 * @nocollapse
 */
DatagridColumnToggleTitle.ctorParameters = function () { return []; };
/*
 * Copyright (c) 2016-2017 VMware, Inc. All Rights Reserved.
 * This software is released under MIT license.
 * The full license information can be found in LICENSE in the root directory of this project.
...
var DatagridColumnToggle = (function () {
     ...
     */
    function DatagridColumnToggle(hideableColumnService, columnToggleButtons) {
        this.hideableColumnService = hideableColumnService;
...
DatagridColumnToggle.propDecorators = {
    'title': [{ type: ContentChild, args: [DatagridColumnToggleTitle,] },],
    'buttons': [{ type: ContentChildren, args: [DatagridColumnToggleButton,] },],
};
/*
 * Copyright (c) 2016-2017 VMware, Inc. All Rights Reserved.
 * This software is released under MIT license.
...
DatagridFooter.propDecorators = {
    'toggle': [{ type: ContentChild, args: [DatagridColumnToggle,] },],
};
/*
 * Copyright (c) 2016-2017 VMware, Inc. All Rights Reserved.
 * This software is released under MIT license.
 ...
 * The full license information can be found in LICENSE in the root directory of this project.
 */
var DatagridItemsTrackBy = (function () {
    /**
     * @param {?} _items
     */
    function DatagridItemsTrackBy(_items) {
        this._items = _items;
    }
    Object.defineProperty(DatagridItemsTrackBy.prototype, "trackBy", {
        /**
         * @param {?} value
         * @return {?}
         */
    ...
    return DatagridItemsTrackBy;
}());
DatagridItemsTrackBy.decorators = [
    { type: Directive, args: [{
 ...
 * @nocollapse
 */
DatagridItemsTrackBy.ctorParameters = function () { return [
    { type: Items, decorators: [{ type: Optional },] },
]; };
DatagridItemsTrackBy.propDecorators = {
 ...
 */
export { FocusTrapTracker as ÇlrFocusTrapTracker, ClarityModule, ClrButtonModule, ClrButtonGroupModule, ClrLoadingButtonModule, ClrSyntaxHighlightModule, ClrDataModule, ClrDatagridModule, ClrStackViewModule, ClrTreeViewModule, ClrEmphasisModule, ClrAlertModule, ClrFormsModule, ClrIconModule, ClrLayoutModule, ClrMainContainerModule, ClrNavigationModule, ClrTabsModule, ClrModalModule, ClrPopoverModule, ClrDropdownModule, ClrTooltipModule, ClrWizardModule, ClrLoadingModule, ALERT_DIRECTIVES, Alert, AlertItem, Alerts, AlertsPager, BUTTON_GROUP_DIRECTIVES, LOADING_BUTTON_DIRECTIVES, CHECKBOX_DIRECTIVES, Checkbox, CODE_HIGHLIGHT_DIRECTIVES, CodeHighlight, DROPDOWN_DIRECTIVES, Dropdown, DropdownMenu, DropdownTrigger, DropdownItem, menuPositions, DATAGRID_DIRECTIVES, Datagrid, DatagridActionBar, DatagridActionOverflow, DatagridColumn, DatagridColumnToggle, DatagridColumnToggleButton, DatagridColumnToggleTitle, DatagridHideableColumnDirective, DatagridFilter, DatagridItems, DatagridItemsTrackBy, DatagridRow, DatagridRowDetail, DatagridCell, DatagridFooter, DatagridPagination, DatagridPlaceholder, SortOrder, DatagridStringFilter, DatagridPropertyStringFilter, DatagridPropertyComparator, TREE_VIEW_DIRECTIVES, TreeNode, STACK_VIEW_DIRECTIVES, StackView, StackViewCustomTags, StackHeader, StackBlock, StackInput, StackSelect, ICON_DIRECTIVES, LAYOUT_DIRECTIVES, MainContainer, MODAL_DIRECTIVES, Modal, NAVIGATION_DIRECTIVES, Header, NavLevelDirective, TABS_DIRECTIVES, Tabs, Tab, TabContent, TabOverflowContent, TabLinkDirective, TOOLTIP_DIRECTIVES, Tooltip, TooltipTrigger, TooltipContent, WIZARD_DIRECTIVES, Wizard, WizardPage, WizardStepnav, WizardStepnavItem, DEFAULT_BUTTON_TYPES, CUSTOM_BUTTON_TYPES, WizardButton, WizardHeaderAction, WizardCustomTags, WizardPageTitleDirective, WizardPageNavTitleDirective, WizardPageButtonsDirective, WizardPageHeaderActionsDirective, collapse, fade, fadeSlide, slide, LOADING_DIRECTIVES, Loading, LoadingListener, Button as ɵcs, ButtonGroup as ɵcu, LoadingButton as ɵcr, ButtonInGroupService as ɵct, ClrCodeModule as ɵcv, DatagridRowExpandAnimation as ɵce, ActionableOompaLoompa as ɵcb, DatagridWillyWonka as ɵbz, ExpandableOompaLoompa as ɵcd, DatagridDetailRegisterer as ɵbp, ColumnToggleButtonsService as ɵbi, CustomFilter as ɵbl, DragDispatcher as ɵbk, FiltersProvider as ɵz, ExpandableRowsCount as ɵbf, HideableColumnService as ɵbg, Items as ɵy, Page as ɵba, RowActionService as ɵbe, Selection as ɵx, Sort as ɵbc, StateDebouncer as ɵbb, StateProvider as ɵbh, DatagridBodyRenderer as ɵbw, DatagridCellRenderer as ɵby, DatagridColumnResizer as ɵbt, DomAdapter as ɵbr, DatagridHeadRenderer as ɵbv, DatagridHeaderRenderer as ɵbs, DatagridMainRenderer as ɵbq, DatagridRenderOrganizer as ɵbd, DatagridRowRenderer as ɵbx, DatagridTableRenderer as ɵbu, DatagridFilterRegistrar as ɵbj, StackControl as ɵci, AbstractTreeSelection as ɵcj, clrTreeSelectionProviderFactory as ɵcl, TreeSelectionService as ɵck, AlertIconAndTypesService as ɵs, MultiAlertService as ɵt, IconCustomTag as ɵa, MainContainerWillyWonka as ɵcy, NavDetectionOompaLoompa as ɵcx, clrResponsiveNavigationProvider as ɵcz, ClrResponsiveNavigationService as ɵcw, AriaService as ɵdd, ActiveOompaLoompa as ɵdj, TabsWillyWonka as ɵdi, TABS_ID as ɵde, TABS_ID_PROVIDER as ɵdg, tokenFactory$1 as ɵdf, TabsService as ɵdh, VERTICAL_NAV_DIRECTIVES as ɵdl, VerticalNavGroupRegistrationService as ɵds, VerticalNavGroupService as ɵdt, VerticalNavIconService as ɵdr, VerticalNavService as ɵdq, VerticalNav as ɵdn, VerticalNavGroup as ɵdm, VerticalNavGroupChildren as ɵdu, VerticalNavIcon as ɵdp, VerticalNavLink as ɵdo, ClrVerticalNavModule as ɵdk, GHOST_PAGE_ANIMATION as ɵcq, AbstractPopover as ɵj, POPOVER_DIRECTIVES as ɵc, POPOVER_HOST_ANCHOR as ɵi, PopoverDirectiveOld as ɵd, ClrCommonPopoverModule as ɵb, ROOT_DROPDOWN_PROVIDER as ɵh, RootDropdownService as ɵf, clrRootDropdownFactory as ɵg, SIGNPOST_DIRECTIVES as ɵdw, Signpost as ɵbn, SignpostContent as ɵdx, SignpostTriggerDirective as ɵbo, ClrSignpostModule as ɵdv, OompaLoompa as ɵcc, WillyWonka as ɵca, ClrConditionalModule as ɵk, IfActiveDirective as ɵm, IF_ACTIVE_ID as ɵo, IF_ACTIVE_ID_PROVIDER as ɵq, IfActiveService as ɵr, tokenFactory as ɵp, IfOpenDirective as ɵn, IfOpenService as ɵe, CONDITIONAL_DIRECTIVES as ɵl, ClrIfExpandModule as ɵcf, IfExpanded as ɵch, EXPAND_DIRECTIVES as ɵcg, Expand as ɵbm, FocusTrapDirective as ɵco, ClrFocusTrapModule as ɵcm, FOCUS_TRAP_DIRECTIVES as ɵcn, OUSTIDE_CLICK_DIRECTIVES as ɵv, OutsideClick as ɵw, ClrOutsideClickModule as ɵu, ScrollingService as ɵcp, TEMPLATE_REF_DIRECTIVES as ɵdb, TemplateRefContainer as ɵdc, ClrTemplateRefModule as ɵda, ButtonHubService as ɵea, HeaderActionService as ɵeb, PageCollectionService as ɵdz, WizardNavigationService as ɵdy };
